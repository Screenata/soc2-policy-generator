...
Use this structure when generating compliance policy documents.
...
satisfies:
  TSC:                          # Include if SOC 2 selected
    - [TSC code, e.g., CC6.1]
    - [Additional TSC codes...]
  ISO27001:                     # Include if ISO 27001 selected
    - [Annex A code, e.g., A.5.15]
    - [Additional Annex A codes...]
majorRevisions:
  - date: [Current date in YYYY-MM-DD format]
    comment: Initial draft generated by compliance-automation
---
```

Only include the `TSC` section if the user selected SOC 2 in Q12. Only include the `ISO27001` section if the user selected ISO 27001 in Q12. Include both if both frameworks were selected.
...
See `.compliance/evidence/` directory for the latest evidence files and `.github/workflows/compliance-*.yml`
